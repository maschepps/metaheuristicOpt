...
MFO <- function(FUN, optimType="MIN", numVar, numPopulation=40, maxIter=500, rangeVar, c_length = 500, c_value = 500, start_pop = generateRandom_orig(40, ncol(rangeVar), rangeVar[1,], rangeVar[2,])){
	...
	moth <- generateRandom(numPopulation, dimension, lowerBound, upperBound, start_pop)
...
#	plot(c(1:old_iter), curve, type="l", main="MFO", log="y", xlab="Number Iteration", ylab = "Best Fittness",
